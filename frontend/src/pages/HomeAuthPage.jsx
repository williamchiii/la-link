...
function HomeAuthpage(){
  ...
  return (
    <div className="relative min-h-screen bg-[#101729] flex flex-col items-center justify-center">
      <WavesBg/>
      <div className="relative z-10 flex flex-col items-center">
        <div className=" text-white text-7xl font-bold italic mb-2">LaLink</div>
        <div className="text-white text-[clamp(0.9rem,4vw,1.75rem)] font-semibold italic mb-6">
